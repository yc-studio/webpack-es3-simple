...
function _testAsync() {
  _testAsync = asyncToGenerator_default()(
  /*#__PURE__*/
...
function src_xx(param1, param2) {
  ...
  try {
    for (var _len = arguments.length, param3 = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
      param3[_key - 2] = arguments[_key];
    }

    console.log(dd, ee, param3);
    throw new Error(param1);
  } catch (UglifyExceptionTest) {
    //Uglify压缩时,对IE8 支持测试
...
src_xx(1, function () {
  console.log(src_test2);
}, 1, 2, 3);
var asyncResult = testAsync();
console.log(asyncResult); // $(() => $('body').append('<span> ES3 OK </span>'));
